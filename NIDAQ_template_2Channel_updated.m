...
ai.addAnalogInputChannel('Dev1','ai2','Voltage');

% Configure the analog input channel for single-ended or differential mode
ai.Channels(1).InputType='SingleEnded';
ai.Channels(2).InputType='SingleEnded';
% set the full scale input range (note this range is variable and can be
% changed)
ai.Channels(1).Range = [-1 1]; % (V)
ai.Channels(2).Range = [-1 1]; % (V)
